/**
 * Write a description of class CopyOfTerm2ProjectLong here.
 *
...
public class CopyOfTerm2ProjectLong
{
    ...
    public void ship5P1CMD(){
        while (ship5P1){
            ...
            if(cmd4.equals("next") || cmd4.equals("n")){
                ship5P1print = true;
                setupBoardPlayer1();
                System.out.println("PLAYER 1 do you want to finish placing your ships?");
    ...
    public void canMoveShips(){
        if (shipPos2X[0] - 1 <= -1)canMoveS2P1L = false;
        else canMoveS2P1L = true;
        if (shipPos2X[1] + 1 >= 10)canMoveS2P1R = false;
        else canMoveS2P1R = true;
        if (shipPos2Y[0] - 1 <= -1)canMoveS2P1U = false;
        else canMoveS2P1U = true;
        if (shipPos2Y[1] + 1 >= 10)canMoveS2P1D = false;
        else canMoveS2P1D = true;
        if (shipPos2X[1] + 1 >= 10)canMoveS2P1T0 = false;
        else canMoveS2P1T0 = true;
        if (shipPos2Y[1] + 1 >= 10)canMoveS2P1T1 = false;
        else canMoveS2P1T1 = true;

        if (shipPos3AX[0] - 1 <= -1)canMoveS3AP1L = false;
        else canMoveS3AP1L = true;
        if (shipPos3AX[2] + 1 >= 10)canMoveS3AP1R = false;
        else canMoveS3AP1R = true;
        if (shipPos3AY[0] - 1 <= -1)canMoveS3AP1U = false;
        else canMoveS3AP1U = true;
        if (shipPos3AY[2] + 1 >= 10)canMoveS3AP1D = false;
        else canMoveS3AP1D = true;
        if (shipPos3AX[2] + 2 >= 10)canMoveS3AP1T0 = false;
        else canMoveS3AP1T0 = true;
        if (shipPos3AY[2] + 2 >= 10)canMoveS3AP1T1 = false;
        else canMoveS3AP1T1 = true;

        if (shipPos3BX[0] - 1 <= -1)canMoveS3BP1L = false;
        else canMoveS3BP1L = true;
        if (shipPos3BX[2] + 1 >= 10)canMoveS3BP1R = false;
        else canMoveS3BP1R = true;
        if (shipPos3BY[0] - 1 <= -1)canMoveS3BP1U = false;
        else canMoveS3BP1U = true;
        if (shipPos3BY[2] + 1 >= 10)canMoveS3BP1D = false;
        else canMoveS3BP1D = true;
        if (shipPos3BX[2] + 2 >= 10)canMoveS3BP1T0 = false;
        else canMoveS3BP1T0 = true;
        if (shipPos3BY[2] + 2 >= 10)canMoveS3BP1T1 = false;
